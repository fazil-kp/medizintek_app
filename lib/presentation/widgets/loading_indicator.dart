  ...
  Widget build(BuildContext context) {
    ...
    return Positioned(
      ...
      child: Container(
        ...
        child: LinearProgressIndicator(value: progress > 0 ? progress / 100 : null, backgroundColor: Colors.transparent, valueColor: AlwaysStoppedAnimation<Color>(const Color(0xFF129247))),
      ),
    );
  }
}
